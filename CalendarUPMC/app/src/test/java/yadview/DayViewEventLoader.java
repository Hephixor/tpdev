...
public class DayViewEventLoader {
    ...
    private static interface LoadRequest {
        public void processRequest(com.google.code.yadview.DayViewEventLoader eventLoader);
        public void skipRequest(com.google.code.yadview.DayViewEventLoader eventLoader);
    }
    ...
    private static class LoadEventsRequest implements LoadRequest {
        ...
        public void processRequest(final com.google.code.yadview.DayViewEventLoader eventLoader) {
    ...
    private static class LoaderThread extends Thread {
        ...
        com.google.code.yadview.DayViewEventLoader mEventLoader;

        public LoaderThread(LinkedBlockingQueue<LoadRequest> queue, com.google.code.yadview.DayViewEventLoader eventLoader) {
            mQueue = queue;
