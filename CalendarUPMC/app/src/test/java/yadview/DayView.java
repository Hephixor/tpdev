...
public class DayView extends View implements ScaleGestureDetector.OnScaleGestureListener, View.OnClickListener
{
    ...
    private final Runnable mSetClick = new Runnable() {
        ...
        public void run() {
            ...
            com.google.code.yadview.DayView.this.invalidate();
        }
    };
            ...
            synchronized (this) {
                ...
                if (mFadingIn) {
                    ...
                    mTodayAnimator = ObjectAnimator
                            .ofInt(com.google.code.yadview.DayView.this, "animateTodayAlpha", 255, 0);
...
//    private float[] mLines;
     ...
     */
    private void initView(com.google.code.yadview.DayView view) {
    ...
    public void switchToDay(int selectionDay) {
        ...
        if ((selectionDay < getFirstJulianDay()) || (selectionDay > getLastJulianDay())) {
            com.google.code.yadview.DayView view = (com.google.code.yadview.DayView) mViewSwitcher.getNextView();
    ...
    private class GotoBroadcaster implements Animation.AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            com.google.code.yadview.DayView view = (com.google.code.yadview.DayView) mViewSwitcher.getCurrentView();
            view.mViewStartX = 0;
            view = (com.google.code.yadview.DayView) mViewSwitcher.getNextView();
            view.mViewStartX = 0;
    ...
    private View switchViews(boolean forward, float xOffSet, float width, float velocity) {
        ...
        view = (com.google.code.yadview.DayView) mViewSwitcher.getCurrentView();
                ...
                if (fadeinEvents) {
                    if (mEventsCrossFadeAnimation == null) {
                        mEventsCrossFadeAnimation =
                                ObjectAnimator.ofInt(com.google.code.yadview.DayView.this, "EventsAlpha", 0, 255);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mScrollController.isHorizontalScrolling()) {
            ...
            com.google.code.yadview.DayView nextView = (com.google.code.yadview.DayView) mViewSwitcher.getNextView();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (DEBUG)
                    Log.e(TAG, "ACTION_MOVE Cnt=" + ev.getPointerCount() + com.google.code.yadview.DayView.this);
                mGestureDetector.onTouchEvent(ev);
                return true;
    ...
    class UpdateCurrentTime implements Runnable {
        public void run() {
            ...
            // etc.)
            if (!com.google.code.yadview.DayView.this.mPaused) {
    ...
    class CalendarGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent ev) {
            ...
            com.google.code.yadview.DayView.this.doSingleTapUp(ev);
            return true;
        }
        ...
        public void onLongPress(MotionEvent ev) {
            ...
            com.google.code.yadview.DayView.this.doLongPress(ev);
        }
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            com.google.code.yadview.DayView.this.doScroll(e1, e2, distanceX, distanceY);
            return true;
        }
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            com.google.code.yadview.DayView.this.doFling(e1, e2, velocityX, velocityY);
            return true;
        }
        ...
        public boolean onDown(MotionEvent ev) {
            ...
            com.google.code.yadview.DayView.this.doDown(ev);
            return true;
        }
    }
